...
import { Carousel, Container, FormControl, Form, Col } from 'react-bootstrap';
    ...
    <div>
      <Container className="d-flex flex-column justify-content align-items-center mt-5 bg-white">
        ...
        <FormControl
          ...
          className="mt-4 w-25 p-3"
        />

        <Form.Label htmlFor="dateFrom">From: </Form.Label>
        <FormControl size="sm" id="dateFrom" type="date" className="w-25" />
        <Form.Label>To: </Form.Label>
        <FormControl size="sm" type="date" className="w-25" />
